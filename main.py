...
def start(message):
    ...
    bot.send_message(
        message.chat.id,
        "Привет 👋 Я расскажу, как проходят консультации по Таро — просто и без мистики.\n\n"
...
def handle_text(message):
    ...
    if user_text in qa_pairs:
        ...
        bot.send_message(message.chat.id, "Отлично 🙌 Я передам специалисту, что ты хочешь записаться. Он свяжется с тобой в ближайшее время.")
    else:
        bot.send_message(
            message.chat.id,
